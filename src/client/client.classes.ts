...
export declare class ClientPed extends Ped {
...
export declare class ClientVehicle extends Vehicle {
    isSphereTouchingVehicle(vec: Vector, radius: number): boolean;
    setHydraulics(status: boolean): void;
}

export declare class ClientPhysical extends Physical {
